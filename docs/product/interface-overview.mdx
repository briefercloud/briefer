...
Once you're done editing a page, you can save it by clicking the "Save" button on the top right corner of the editor.

**In a way, saving a page is similar to "git commit" in that it saves the current state of the page as the latest version.**

<Info>
  The saving mechanism exists so that editors can make changes to a page without
  disrupting the people who are viewing it.
</Info>

To edit a page that has already been saved, click the "Edit" button on the top right corner of the editor. This will take you to the the editor where you can make changes.
...
<Tip>
  Search for a document by clicking the magnifying glass icon next to the
  "Pages" title (or by pressing `Cmd+K` on Mac or `Ctrl+K` on Windows).
</Tip>
