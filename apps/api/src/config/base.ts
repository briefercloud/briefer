...
export class BaseConfig implements IBaseConfig {
  ...
  public TLD: string
  public LOGIN_LINK_EXPIRATION: string
  public LOGIN_JWT_SECRET: string
  public AUTH_JWT_EXPIRATION: string
  public AUTH_JWT_SECRET: string
  public AI_API_URL: string
  public AI_API_USERNAME: string
  public AI_API_PASSWORD: string
  public PYTHON_ALLOWED_LIBRARIES: string
  public POSTGRES_USERNAME: string
  public POSTGRES_HOSTNAME: string
  public POSTGRES_PORT: string
  public POSTGRES_DATABASE: string
  public POSTGRES_PASSWORD: string
  public POSTGRES_CONNECTION_LIMIT: number
