-- CreateEnum
CREATE TYPE "OnboardingTutorialStep" AS ENUM ('connectDataSource', 'runQuery', 'createVisualization', 'publishDashboard', 'inviteTeamMembers');

-- CreateTable
CREATE TABLE "OnboardingTutorial" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "workspaceId" UUID NOT NULL,
    "currentStep" "OnboardingTutorialStep" NOT NULL,
