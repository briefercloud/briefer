...
- `OIDC_REDIRECT_TIMEOUT` is the time in seconds that Briefer will wait for the user to authenticate with the IdP. The default is 1 hour.
  <Info>
...
<Note>
  If you need to automatically create users in Briefer when they log in for the first time, please let us know. This is a new feature that we'd love to improve based on your feedback.
</Note>
